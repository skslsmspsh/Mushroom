# -*- coding: utf-8 -*-
"""
Created on Mon Nov  7 16:17:31 2022
...
def get_data():
    ...
    x = data.iloc[:,1:]
    y = data['class']
    #'cap-surface','spore-print-color','population','habitat'
    # column 제거 (분류 기준이 많을 수록 정확도는 높지만 서비스 이용자가 일반인임을 간주하여 일반인의 눈으로 아래 모든 사항들을 조사하기는 어려우므로 최소의 정보들로 최대의 효율)
    list = [ 'habitat','population','cap-surface','spore-print-color','bruises','gill-attachment','gill-spacing', 'gill-size','gill-color','stalk-root',
